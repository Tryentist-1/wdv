        ...
        (function() {
            ...
            const TOTAL_ROUNDS = 12;  // Updated from 10 to 12 for a 360 round
            let currentTab = 0;
            let scores = [];
            let archerNames = [];
            ...
            function updateTitles() {
                ...
                document.getElementById('main-title').innerText = `360 Round - ${formattedDate}`;
                document.title = `360 Round - ${formattedDate}`; // Updates browser tab title
            }
            ...
            function generateSampleData() {
                scores = [
                    [
                        { arrow1: 'M', arrow2: 'M', arrow3: 'M' },
                        { arrow1: '1', arrow2: '1', arrow3: '1' },
                        { arrow1: '3', arrow2: '3', arrow3: '3' },
                        { arrow1: '4', arrow2: '4', arrow3: '4' },
                        { arrow1: '5', arrow2: '5', arrow3: '5' },
                        { arrow1: '6', arrow2: '6', arrow3: '6' },
                        { arrow1: '7', arrow2: '7', arrow3: '7' },
                        { arrow1: '8', arrow2: '8', arrow3: '8' },
                        { arrow1: '9', arrow2: '9', arrow3: '9' },
                        { arrow1: '10', arrow2: '10', arrow3: '10' },
                        { arrow1: 'X', arrow2: 'X', arrow3: 'X' },
                    ...
                    [
                        ...
                        { arrow1: '9', arrow2: '8', arrow3: '7' },
                        { arrow1: '10', arrow2: '7', arrow3: '8' }
                    ],
                    [
                        { arrow1: '8', arrow2: '7', arrow3: '9' },
