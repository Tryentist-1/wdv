...
CREATE TABLE IF NOT EXISTS archers (
  ...
  email2 VARCHAR(200) NULL COMMENT 'Secondary email',
  phone VARCHAR(20) NULL,
  dob DATE NULL COMMENT 'Date of birth',
  nationality VARCHAR(100) NULL DEFAULT 'U.S.A.' COMMENT 'Nationality',
  ethnicity VARCHAR(100) NULL COMMENT 'Ethnicity',
  discipline VARCHAR(20) NULL COMMENT 'Recurve, Compound, or Barebow',
  street_address VARCHAR(255) NULL COMMENT 'Street address line 1',
  street_address2 VARCHAR(255) NULL COMMENT 'Street address line 2',
  ...
  disability VARCHAR(255) NULL COMMENT 'Disability information',
  camp_attendance CHAR(1) NULL COMMENT 'Y or N for camp attendance',
...
CREATE TABLE IF NOT EXISTS round_archers (
  ...
  locked BOOLEAN DEFAULT FALSE COMMENT 'Card locked after verification',
  card_status VARCHAR(16) NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING, VER, VOID',
  notes TEXT NULL COMMENT 'Verification notes / void reason',
  lock_history TEXT NULL COMMENT 'JSON array of lock/unlock events',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
